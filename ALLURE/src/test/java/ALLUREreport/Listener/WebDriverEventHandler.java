package ALLUREreport.Listener;

import ALLUREreport.tests.BaseSetupTest;
...
public class WebDriverEventHandler extends BaseSetupTest implements WebDriverEventListener {
    @Override
